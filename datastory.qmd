...
```{r, out.height= "200px",out.width="800px",echo=FALSE,eval=TRUE, fig.align='center'}
knitr::include_graphics("src/images/HDB-flat-after-divorce.jpg")
```
...
```{r, out.height= "200px",out.width="800px",echo=FALSE,eval=TRUE, fig.align='center', fig.cap="Estimation of Average Salary Per Spouse (Kumar, 2022)"}
knitr::include_graphics("docs/images/dreamhome.png")
```
...
average_prices_1999 <- data1999 %>%
  group_by(flat_type) %>%
  summarise("1999" = mean(resale_price))
...
ggplot(long_data, aes(x = flat_type, y = AveragePrice, group = Year, color = Year)) +
  ...
  labs(title = "Average Resale Price in 1999 and 2022 (Flat Type, SGD)",
       x = "Flat Type",
